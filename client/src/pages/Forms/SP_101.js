...
function SP_101({ formData }) {
    ...
    //values to be obtained from purchase section
    let startPageNo= 1;
    let endPageNo = 1;
    let rsInValue = 4000;
    ...
    if (formData === null) {
        ...
        console.log("error please fill the form correctly");
    ...
    doc.text('Datedd: ', pageWidth - 55, 15)
    var today = new Date();
    ...
    //     if (!today)
    //         return '';
    //     const month = today.getMonth() + 1; // + 1 because 0 indicates the first Month of the Year.
